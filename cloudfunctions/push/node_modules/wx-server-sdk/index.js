    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, tcb.callCompatibleWxOpenApi({
                            apiName: options.api,
                            requestData: options.data,
                        })
                        // console.log('wx-server-sdk tcb.callWxOpenApi res: ', res)
...
exports.getInstance = function (config) {
    ...
    /*
    if (!config.env || tcb.config.envName === config.env) {
      return tcb
    } else if (process.env.TENCENTCLOUD_RUNENV === 'WX_LOCAL_SCF') {
      // @ts-ignore
      return tcb.init({
        ...tcb.config,
        env: tcb.config.envName,
        ...config,
        isHttp: true,
      })
    } else {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        pbMessage = openapi_1.OpenApiData.encode({
                            pairs: pairs,
                        }).finish();
